...
HOMEBREW_NO_AUTO_UPDATE=1 brew install intltool gettext json-c json-glib glib-networking
HOMEBREW_NO_AUTO_UPDATE=1 brew reinstall --build-from-source exiv2 gexiv2
